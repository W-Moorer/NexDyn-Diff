...
if(NOT COMMAND FindOrFetch)
  macro(FindOrFetch)
    ...
    if(NOT _ARGS_TARGETS)
      message(FATAL_ERROR "simcore::FindOrFetch: TARGETS must be specified.")
    endif()

    set(targets_found TRUE)
    message(CHECK_START
            "simcore::FindOrFetch: checking for targets in package `${_ARGS_PACKAGE_NAME}`"
    )
    ...
    if(NOT targets_found)
      if(${_ARGS_USE_SYSTEM_PACKAGE})
        message(CHECK_START
                "simcore::FindOrFetch: finding `${_ARGS_PACKAGE_NAME}` in system packages..."
        )
        find_package(${_ARGS_PACKAGE_NAME} REQUIRED)
        message(CHECK_PASS "found")
      else()
        message(CHECK_START
                "simcore::FindOrFetch: Using FetchContent to retrieve `${_ARGS_LIBRARY_NAME}`"
        )
