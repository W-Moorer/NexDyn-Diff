...
if(APPLE)
  ...
  set(SIMCORE_MACOSX_VERSION_MIN 11)
  ...
  set(SIMCORE_MACOS_COMPILE_OPTIONS -mmacosx-version-min=${SIMCORE_MACOSX_VERSION_MIN}
                                   -Werror=partial-availability -Werror=unguarded-availability
  )
  set(SIMCORE_MACOS_LINK_OPTIONS -mmacosx-version-min=${SIMCORE_MACOSX_VERSION_MIN}
                                -Wl,-no_weak_imports
  )
else()
  set(SIMCORE_MACOS_COMPILE_OPTIONS "")
  set(SIMCORE_MACOS_LINK_OPTIONS "")
endif()

function(enforce_simcore_macosx_min_version)
  if(APPLE)
    add_compile_options(${SIMCORE_MACOS_COMPILE_OPTIONS})
    add_link_options(${SIMCORE_MACOS_LINK_OPTIONS})
  endif()
endfunction()
