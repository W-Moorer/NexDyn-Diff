...
set(BUILD_SHARED_LIBS
    ON
    CACHE BOOL "Build simcore as shared library."
)

option(SIMCORE_ENABLE_AVX "Build binaries that require AVX instructions, if possible." ON)
option(SIMCORE_ENABLE_AVX_INTRINSICS "Make use of hand-written AVX intrinsics, if possible." ON)
option(SIMCORE_ENABLE_RPATH "Enable RPath support when installing simcore." ON)
mark_as_advanced(SIMCORE_ENABLE_RPATH)

if(SIMCORE_ENABLE_AVX)
...
option(SIMCORE_BUILD_MACOS_FRAMEWORKS "Build libraries as macOS Frameworks" OFF)

# Get some extra link options.
include(SimcoreLinkOptions)
get_simcore_extra_link_options(EXTRA_LINK_OPTIONS)
...
include(SimcoreHarden)
set(EXTRA_COMPILE_OPTIONS ${EXTRA_COMPILE_OPTIONS} ${SIMCORE_HARDEN_COMPILE_OPTIONS})
set(EXTRA_LINK_OPTIONS ${EXTRA_LINK_OPTIONS} ${SIMCORE_HARDEN_LINK_OPTIONS})
