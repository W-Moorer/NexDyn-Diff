...
function(add_SIMCORE_shell_test TEST_NAME TARGET_BINARY)
  ...
  if(BASH_PROGRAM)
    ...
    if(WIN32)
      # Define the directory containing the simcore DLL library so that it can be added to the PATH.
      # We modify the PATH in the script as it is more reliable.
      set_property(
        TEST "${TEST_NAME}"
        APPEND
        PROPERTY ENVIRONMENT "SIMCORE_DLL_DIR=$<TARGET_FILE_DIR:simcore>"
      )
    endif()
  endif()
endfunction()
