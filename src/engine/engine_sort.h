...
#ifndef SIMCORE_SRC_ENGINE_ENGINE_SORT_H_
#define SIMCORE_SRC_ENGINE_ENGINE_SORT_H_
...
#define SIM_PARTIAL_SORT(name, type, cmp)                                                            \
...
#endif  // SIMCORE_SRC_ENGINE_ENGINE_SORT_H_
